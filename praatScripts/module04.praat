...
clearinfo
form Parameters
	text directory /path/to/files/
	text aligned /path/to/files/
	text basename s249
endform

include proceed_std.praat

Read from file: aligned$ + basename$ + ".TextGrid"
Read from file: directory$ + basename$ + "_mod3.TextGrid"
...
for w to words
	...
	#appendInfoLine: "Current word at tier 2 is = ", lab_word$
	if lab_word$ == ""
...
for x to n_sil
	...
	if checksil$ != "SIL"
		...
		if dev != 0 and mean != 0
			...
			# appendInfoLine: "add feature lab text", labtextx$
...
#				appendInfoLine: "feature inserted = ", dur_phone$
#			endfor
...
for w to totintWord
	@intervalInfo: 5, w
	# appendInfoLine: "Current word is = ", lab$
	if lab$ != ""
...
## Write F0 features to interval
		...
		#appendInfoLine: "add feature ", labeltextw$
...
######################################################		
		...
		# appendInfoLine: "number of phones = ", phones_word
		if phones_word > 1
			dev = 0
...
#				Set interval text: 6, point, newlabph$
			...
			# appendInfoLine: "current phone = ", lastPhone
			...
			# appendInfoLine: "for 2+ phone ", newlabword2$
			...
			# appendInfoLine: "for 1 phone only", newlabword3$
		endif
	endif
endfor
...
selectObject: merged$
#appendInfoLine: "output ", merged$
#Write to text file: directory$ + basename$ + "_sum4.TextGrid"  
Save as text file: directory$ + basename$ + "_sum4.TextGrid"  
